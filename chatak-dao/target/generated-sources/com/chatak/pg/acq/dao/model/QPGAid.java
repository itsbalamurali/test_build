...
/**
 * QPGAid is a Querydsl query type for PGAid
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QPGAid extends EntityPathBase<PGAid> {

    private static final long serialVersionUID = -770388787L;

    public static final QPGAid pGAid = new QPGAid("pGAid");
    ...
    public QPGAid(String variable) {
        super(PGAid.class, forVariable(variable));
    }

    public QPGAid(Path<? extends PGAid> path) {
        super(path.getType(), path.getMetadata());
    }

    public QPGAid(PathMetadata<?> metadata) {
        super(PGAid.class, metadata);
    }
