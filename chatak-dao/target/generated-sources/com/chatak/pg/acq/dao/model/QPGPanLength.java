...
/**
 * QPGPanLength is a Querydsl query type for PGPanLength
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QPGPanLength extends EntityPathBase<PGPanLength> {

    private static final long serialVersionUID = -804007756L;

    public static final QPGPanLength pGPanLength = new QPGPanLength("pGPanLength");
    ...
    public final NumberPath<Long> panLength = createNumber("panLength", Long.class);

    public final NumberPath<Long> panLengthId = createNumber("panLengthId", Long.class);
    ...
    public QPGPanLength(String variable) {
        super(PGPanLength.class, forVariable(variable));
    }

    public QPGPanLength(Path<? extends PGPanLength> path) {
        super(path.getType(), path.getMetadata());
    }

    public QPGPanLength(PathMetadata<?> metadata) {
        super(PGPanLength.class, metadata);
    }
