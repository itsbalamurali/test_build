...
/**
 * QPGTransactionCategoryCode is a Querydsl query type for PGTransactionCategoryCode
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QPGTransactionCategoryCode extends EntityPathBase<PGTransactionCategoryCode> {

    private static final long serialVersionUID = 1217387290L;

    public static final QPGTransactionCategoryCode pGTransactionCategoryCode = new QPGTransactionCategoryCode("pGTransactionCategoryCode");
    ...
    public final StringPath transactionCategoryCode = createString("transactionCategoryCode");
    ...
    public QPGTransactionCategoryCode(String variable) {
        super(PGTransactionCategoryCode.class, forVariable(variable));
    }

    public QPGTransactionCategoryCode(Path<? extends PGTransactionCategoryCode> path) {
        super(path.getType(), path.getMetadata());
    }

    public QPGTransactionCategoryCode(PathMetadata<?> metadata) {
        super(PGTransactionCategoryCode.class, metadata);
    }
