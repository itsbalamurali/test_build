...
/**
 * QPGLocalCurrencyCode is a Querydsl query type for PGLocalCurrencyCode
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QPGLocalCurrencyCode extends EntityPathBase<PGLocalCurrencyCode> {

    private static final long serialVersionUID = 1297043066L;

    public static final QPGLocalCurrencyCode pGLocalCurrencyCode = new QPGLocalCurrencyCode("pGLocalCurrencyCode");
    ...
    public QPGLocalCurrencyCode(String variable) {
        super(PGLocalCurrencyCode.class, forVariable(variable));
    }

    public QPGLocalCurrencyCode(Path<? extends PGLocalCurrencyCode> path) {
        super(path.getType(), path.getMetadata());
    }

    public QPGLocalCurrencyCode(PathMetadata<?> metadata) {
        super(PGLocalCurrencyCode.class, metadata);
    }
